 ...
 * @author asanabria
 */
public class TaxonDescriptionTransformer 
    ...
    public List transformList(List list) {
        ...
        List<TaxonDescriptionLiteCDTO> newList = new ArrayList<TaxonDescriptionLiteCDTO>();

        for(TaxonDescription taxonDescription: taxonList){
            
                       
            newList.add(
                new TaxonDescriptionLiteCDTO(
                    taxonDescription.getScientificName(),
                    taxonDescription.getCommonNames(),
                    taxonDescription.getInstitutionCode()));
        }
