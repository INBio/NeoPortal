...
public class Taxon  implements java.io.Serializable {
    ...
    /** full constructor */
    public Taxon(BigDecimal taxonId, 
        Taxon taxonBySinonymTaxonId, 
        Taxon taxonByAncestorTaxonId, 
        BigDecimal taxonomicalRangeId, 
        String defaultName, 
        String kingdom, 
        String division, 
        String class_, 
        ...
        String genus, 
        String species, 
        BigDecimal dominiumId, 
        BigDecimal kingdomId, 
        BigDecimal divisionId, 
        BigDecimal subdivisionId,
        BigDecimal classId, 
        BigDecimal subclassId, 
        BigDecimal orderId,
        BigDecimal subOrderId,
        BigDecimal superFamilyId, 
        BigDecimal familyId,
        BigDecimal subFamilyId,
        BigDecimal tribeId, 
        BigDecimal subTribeId,
        BigDecimal genusId, 
        BigDecimal subGenusId,
        BigDecimal sectionId,
        BigDecimal subSectionId, 
        BigDecimal raceId, 
        BigDecimal speciesId, 
        BigDecimal subSpeciesId,
        BigDecimal varietyId, 
        BigDecimal formId, 
        Set<TaxonHasReferenceElement> taxonHasReferenceElements, 
        Set<Occurrence> occurrences,
        Set<Taxon> taxonsForSinonymTaxonId,
        Set<CommonName> commonNames, 
        Set<Taxon> taxonsForAncestorTaxonId, 
    ...
    public void setTaxonsForAncestorTaxonId(
        Set<Taxon> taxonsForAncestorTaxonId) {
