...
<%-- 			<nav><ul> --%>
<%-- 				<li  role="presentation" class="active"><a href="${taxonUrl}"><fmt:message key="tab_taxonDescription" /></a></li> --%>
<%-- 				<li role="presentation"><a href="${taxonUrl}/images"><fmt:message key="tab_images" /></a></li> --%>
<%-- 				<li role="presentation"><a href="${taxonUrl}/occurrences"><fmt:message key="tab_occurrences" /></a></li> --%>
<%-- 				<li role="presentation"><a href="${taxonUrl}/map"><fmt:message key="tab_map" /></a></li> --%>
<%-- 			</ul></nav> --%>
